    ...
    <>
      ...
      <Container className="mt-2">
        <div className="mx-auto" style={{ maxWidth: '800px', border: '2px dashed #3498db', padding: '40px', marginBottom: '20px' }}>
          <h3 className="text-center mb-4">Generate YouTube Titles With AI</h3>
          ...
          {paragraph && (
            <div className="mt-3">
              <h5 className="text-center">Generated YouTube Titles By AI</h5>
