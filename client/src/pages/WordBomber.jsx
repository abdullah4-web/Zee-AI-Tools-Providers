...
const WordBomber = () => {
  ...
  const handleSubmit = () => {
    ...
    fetch(`/api/v1/ai/keyword?country=${country}&query=${query}`)
  ...
  return (
    <Container className="mt-3">
      <Card className="mx-auto" style={{ maxWidth: '800px', border: '2px dashed #3498db', padding: '20px', marginBottom: '20px' }}>
        <h3 className="text-center mb-4">KeyWord Bomber</h3>
        ...
        {result && (
          <Card className="mt-3">
            <Card.Body>
              <h5>Keywords</h5>
              {renderKeywords(result.Questions)}
              {renderKeywords(result.Prepositions)}
              {renderKeywords(result.Alphabet)}
            </Card.Body>
          </Card>
        )}
      </Card>
